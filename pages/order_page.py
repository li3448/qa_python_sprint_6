...
class OrderPage(BasePage):
    ...
    def push_button(self, locator):
        ...
        #self.ActionChains(driver).move_to_element(locator_q).click.perform()
    ...
    def first_fill(self,
        ...
        self.add_text_to_element((method_q, locator_q), name)

        method_q, locator_q = second_name_locator
        self.add_text_to_element((method_q, locator_q), second_name)

        method_q, locator_q = adress_locator
        self.add_text_to_element((method_q, locator_q), adress)
        ...
        self.add_text_to_element((method_q, locator_q), phone)
    ...
    def second_fill(self,
        ...
        self.add_text_to_element((method_q, locator_q), commentary)
